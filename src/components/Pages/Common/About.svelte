<script>
  ...
  const openLink = (url) => {
    url = url.replace('{{TEMPLATE_TEXT}}', $_("Try pertinax wallet web-extension for everscale blockchain"));
    url = url.replace('{{TEMPLATE_URL}}', "https://pertinaxwallet.com/installation");
    url = url.replace('{{TEMPLATE_IMAGE}}', "https://pertinaxwallet.com/images/big_logo.png");
  ...
  <div class="about-box">
    <Card>
      ...
      <div slot="footer" class="is-right">
        <a href="https://pertinaxwallet.com" target="_blank" title="{$_("Visit website")}">{$_("Visit website")}</a>
      </div>
    </Card>
  </div>
